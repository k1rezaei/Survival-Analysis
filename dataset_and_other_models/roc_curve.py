...
with open('files_cancer_gov/rsf.npy', 'rb') as f:
    rsf_train = np.load(f)
    rsf_test = np.load(f)

with open('files_cancer_gov/gbs.npy', 'rb') as f:
    gbs_train = np.load(f)
    gbs_test = np.load(f)

with open('files_cancer_gov/cwgbs.npy', 'rb') as f:
    cwgbs_train = np.load(f)
    cwgbs_test = np.load(f)

with open('files_cancer_gov/coxph.npy', 'rb') as f:
    coxph_train = np.load(f)
    coxph_test = np.load(f)

with open('files_cancer_gov/coxnet.npy', 'rb') as f:
...
plt.savefig('files_cancer_gov/AUC_train.png', dpi=500)
plt.show()
...
plt.savefig('files_cancer_gov/AUC_test.png', dpi=500)
plt.show()'''
